...
all_df = pd.read_csv("https://raw.githubusercontent.com/mmhdagungg/e-commerce-publict-data-analysis/refs/heads/main/dashboard/df.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Data Geolocation
geolocation = pd.read_csv("https://raw.githubusercontent.com/mmhdagungg/e-commerce-publict-data-analysis/refs/heads/main/dashboard/geolocation.csv")
...
sns.barplot(x="product_count", y="product_category_name_english", data=sum_order_items_df.head(5), palette="coolwarm", ax=ax[0])
...
sns.barplot(x="product_count", y="product_category_name_english", data=sum_order_items_df.sort_values(by="product_count", ascending=True).head(5), palette="coolwarm", ax=ax[1])
...
fig, ax = plt.subplots(figsize=(12, 6))
colors = sns.color_palette("coolwarm", len(review_score))
...
st.caption('Copyright (C) Moehammad Agung Putra Darmawan')
